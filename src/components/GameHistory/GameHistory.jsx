      ...
      <>
         <p className={classes.game__players}>
            <div className={classes.game__item}>
               <img className={classes.game__icon} src={littleZero} alt='Иконка нолик' />
               <p className={classes.game__name}>{props.userNameZero}</p>
               {
                  props.isVictory.zero && <img className={classes.game__cupIcon} src={cup} alt='Иконка кубок' />
               }
            </div>
            <p className={classes.game__text}>против</p>
            <div className={classes.game__item}>
               <img className={classes.game__icon} src={littleCross} alt='Иконка кубок' />
               <p className={classes.game__name}>{props.userNameCross}</p>
               {
                  props.isVictory.cross && <img className={classes.game__cupIcon} src={cup} alt='Иконка крестик' />
               }
            </div>
         </p>
